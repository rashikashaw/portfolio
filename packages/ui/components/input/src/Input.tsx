...
import {
  InputWithIncreaseDecrease,
  InputWithIncreaseDecreaseProps,
} from './InputWithIncreaseDecrease';
import { InputBaseProps } from './InputBase';

type InputProps = InputBaseProps & {
  variant?: 'regular' | 'icon' | 'clear-button' | 'increment-decrement';
} & (InputWithIconProps & InputWithClearButtonProps & InputWithIncreaseDecreaseProps);
...
export const Input = (props: InputProps) => {
  ...
  switch (variant) {
    ...
    case 'clear-button': {
      return <InputWithClearButton {...props} />;
    }
    case 'increment-decrement': {
      return <InputWithIncreaseDecrease {...props} />;
    }
    default: {
      return <InputRegular {...props} />;
    }
